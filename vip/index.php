			        ...
			        <span class="icon-bar"></span>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li>
									<a href="http://www.12580sky.com" target="_blank">小高教学网</a>
								</li>
								<li>
									<a href="http://www.weifenshi.com/" target="_blank"> <span class="badge" style="background: red;margin-right:5px ;">NEW</span>成人影院<span class="sr-only">(current)</span></a>
								</li>
								<li>
